document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!window.auth.checkUserRole(['autoridad'])) {
    ...
    // Obtener userId de la autoridad desde el token
    let userId = null;
    try {
    ...
    // Obtener solo los reportes asignados a la autoridad
    fetch(`${API_URL}/dashboard/mis-tareas`, {
        headers: { 'Authorization': `Bearer ${token}` }
    })
